	...
	$.easyTabs = function(params) {
		...
		var self={
				settings:{
					...
					bootstrap	: typeof params.bootstrap			===	'number'	?	params.bootstrap		:	3,
		...
		var easyTabsObj=function(settings){
			...
			var _bindEvents=function(){
				...
				if(self.settings.bootstrap==3){
					_$tab.css({
						width	: _$tab.find(".modal-dialog").width()+50,
						height	: _$tab.find(".modal-dialog").height()+65,
						overflow: "hidden"
					});
				}
			};
