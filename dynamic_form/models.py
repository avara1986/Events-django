...
class Question(models.Model):
    ...
    questioner = models.ForeignKey(DYNAMIC_FORM_QUESTION_FK_MODEL, verbose_name=_('Formulario'))

    class Meta:
        app_label = DYNAMIC_FORM_MODEL_IMPORT
...
class Answer(models.Model):
    answerer = models.ForeignKey(DYNAMIC_FORM_ANSWER_FK_MODEL, verbose_name=_('Respondedor'))
